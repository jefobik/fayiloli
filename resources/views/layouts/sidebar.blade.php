...
<div class="sidebar-logo flex items-center h-16 shrink-0 group overflow-hidden"
    ...
    class="flex items-center gap-3 text-[var(--color-primary)] dark:text-[var(--color-primary-hover)] no-underline
    ...
    <span x-show="!sidebarCollapsed" x-cloak
        class="font-bold text-xl tracking-tight text-slate-900 dark:text-white whitespace-nowrap">
        {{ $tenant?->short_name ?? 'Ostrich' }}
    </span>
    <span x-show="!sidebarCollapsed" x-cloak
        class="text-[0.65rem] font-bold px-1.5 py-0.5 rounded bg-[var(--color-primary)]/10 text-[var(--color-primary)] dark:bg-[var(--color-primary)]/20 dark:text-[var(--color-primary)] shrink-0"
...
<nav class="flex flex-1 flex-col mt-4 overflow-hidden" aria-label="Main navigation">
    ...
    : 'border-l-[3px] border-transparent text-[var(--color-text-main)] hover:text-[var(--color-primary)] hover:bg-[var(--color-surface-hover)] dark:text-[var(--color-text-main-dark)] dark:hover:text-[var(--color-primary)] dark:hover:bg-[var(--color-surface-hover-dark)] pl-2.25' }}"
        :class="sidebarCollapsed ? 'justify-center px-2' : ''" {{ Route::is('home') ? 'aria-current=page' : '' }}>
    ...
    @if ($canDocs)
        <a href="{{ route('documents.index') }}" wire:navigate title="Documents"
            ...
            ? 'border-l-[3px] border-[var(--color-primary)] bg-[var(--color-primary)]/10 text-[var(--color-primary)] dark:bg-[var(--color-primary)]/20 dark:text-[var(--color-primary)] pl-2.25'
            : 'border-l-[3px] border-transparent text-[var(--color-text-main)] hover:text-[var(--color-primary)] hover:bg-[var(--color-surface-hover)] dark:text-[var(--color-text-main-dark)] dark:hover:text-[var(--color-primary)] dark:hover:bg-[var(--color-surface-hover-dark)] pl-2.25' }}"
            :class="sidebarCollapsed ? 'justify-center px-2' : ''" {{ Route::is('documents.index') ? 'aria-current=page' : '' }}>
            ...
            <span x-show="!sidebarCollapsed" x-cloak class="badge ml-auto text-xs" id="sidebar-doc-count"
    ...
    @if ($canTags)
        <a href="{{ route('tags.index') }}" wire:navigate title="Tags"
            ...
            ? 'border-l-[3px] border-[var(--color-primary)] bg-[var(--color-primary)]/10 text-[var(--color-primary)] dark:bg-[var(--color-primary)]/20 dark:text-[var(--color-primary)] pl-2.25'
            : 'border-l-[3px] border-transparent text-[var(--color-text-main)] hover:text-[var(--color-primary)] hover:bg-[var(--color-surface-hover)] dark:text-[var(--color-text-main-dark)] dark:hover:text-[var(--color-primary)] dark:hover:bg-[var(--color-surface-hover-dark)] pl-2.25' }}"
            :class="sidebarCollapsed ? 'justify-center px-2' : ''" {{ Route::is('tags.*') ? 'aria-current=page' : '' }}>
    ...
    @if ($canDocs && Route::is('documents.index'))
        ...
        <ul x-show="!sidebarCollapsed" x-cloak class="folders space-y-1" aria-label="Workspace folders"
        ...
        @if ($canUsers)
            <a href="{{ route('users.index') }}" wire:navigate title="Users"
                class="group flex items-center min-h-[44px] gap-x-3 rounded-md py-2 text-sm font-semibold mb-1 transition-all duration-200 overflow-hidden
                    ...
                    ? 'border-l-[3px] border-[var(--color-primary)] bg-[var(--color-primary)]/10 text-[var(--color-primary)] dark:bg-[var(--color-primary)]/20 dark:text-[var(--color-primary)] pl-2.25'
                    : 'border-l-[3px] border-transparent text-[var(--color-text-main)] hover:text-[var(--color-primary)] hover:bg-[var(--color-surface-hover)] dark:text-[var(--color-text-main-dark)] dark:hover:text-[var(--color-primary)] dark:hover:bg-[var(--color-surface-hover-dark)] pl-2.25' }}"
                :class="sidebarCollapsed ? 'justify-center px-2' : ''" {{ Route::is('users.*') ? 'aria-current=page' : '' }}>
        ...
        @if ($canRoles)
            <a href="{{ route('roles.index') }}" wire:navigate title="Roles &amp; Permissions"
                class="group flex items-center min-h-[44px] gap-x-3 rounded-md py-2 text-sm font-semibold mb-1 transition-all duration-200 overflow-hidden
                    ...
                    ? 'border-l-[3px] border-[var(--color-primary)] bg-[var(--color-primary)]/10 text-[var(--color-primary)] dark:bg-[var(--color-primary)]/20 dark:text-[var(--color-primary)] pl-2.25'
                    : 'border-l-[3px] border-transparent text-[var(--color-text-main)] hover:text-[var(--color-primary)] hover:bg-[var(--color-surface-hover)] dark:text-[var(--color-text-main-dark)] dark:hover:text-[var(--color-primary)] dark:hover:bg-[var(--color-surface-hover-dark)] pl-2.25' }}"
                :class="sidebarCollapsed ? 'justify-center px-2' : ''" {{ Route::is('roles.*') ? 'aria-current=page' : '' }}>
        ...
        @if ($canProj)
            <a href="{{ route('projects.index') }}" wire:navigate title="Projects"
                class="group flex items-center min-h-[44px] gap-x-3 rounded-md py-2 text-sm font-semibold mb-1 transition-all duration-200 overflow-hidden
                    ...
                    ? 'border-l-[3px] border-[var(--color-primary)] bg-[var(--color-primary)]/10 text-[var(--color-primary)] dark:bg-[var(--color-primary)]/20 dark:text-[var(--color-primary)] pl-2.25'
                    : 'border-l-[3px] border-transparent text-[var(--color-text-main)] hover:text-[var(--color-primary)] hover:bg-[var(--color-surface-hover)] dark:text-[var(--color-text-main-dark)] dark:hover:text-[var(--color-primary)] dark:hover:bg-[var(--color-surface-hover-dark)] pl-2.25' }}"
                :class="sidebarCollapsed ? 'justify-center px-2' : ''" {{ Route::is('projects.*') ? 'aria-current=page' : '' }}>
        ...
        @if ($canHrm)
            <a href="{{ route('hrm.index') }}" wire:navigate title="Human Resources"
                class="group flex items-center min-h-[44px] gap-x-3 rounded-md py-2 text-sm font-semibold mb-1 transition-all duration-200 overflow-hidden
                    ...
                    ? 'border-l-[3px] border-[var(--color-primary)] bg-[var(--color-primary)]/10 text-[var(--color-primary)] dark:bg-[var(--color-primary)]/20 dark:text-[var(--color-primary)] pl-2.25'
                    : 'border-l-[3px] border-transparent text-[var(--color-text-main)] hover:text-[var(--color-primary)] hover:bg-[var(--color-surface-hover)] dark:text-[var(--color-text-main-dark)] dark:hover:text-[var(--color-primary)] dark:hover:bg-[var(--color-surface-hover-dark)] pl-2.25' }}"
                :class="sidebarCollapsed ? 'justify-center px-2' : ''" {{ Route::is('hrm.*') ? 'aria-current=page' : '' }}>
        ...
        @if ($canStats)
            <a href="{{ route('stats.index') }}" wire:navigate title="Statistics"
                class="group flex items-center min-h-[44px] gap-x-3 rounded-md py-2 text-sm font-semibold mb-1 transition-all duration-200 overflow-hidden
                    ...
                    ? 'border-l-[3px] border-[var(--color-primary)] bg-[var(--color-primary)]/10 text-[var(--color-primary)] dark:bg-[var(--color-primary)]/20 dark:text-[var(--color-primary)] pl-2.25'
                    : 'border-l-[3px] border-transparent text-[var(--color-text-main)] hover:text-[var(--color-primary)] hover:bg-[var(--color-surface-hover)] dark:text-[var(--color-text-main-dark)] dark:hover:text-[var(--color-primary)] dark:hover:bg-[var(--color-surface-hover-dark)] pl-2.25' }}"
                :class="sidebarCollapsed ? 'justify-center px-2' : ''" {{ Route::is('stats.*') ? 'aria-current=page' : '' }}>
    ...
    <button type="button"
        class="hidden lg:flex items-center min-h-[44px] justify-center w-full py-2 mt-4 rounded-md text-slate-500 dark:text-slate-400 hover:text-[var(--color-primary)] hover:bg-slate-100 dark:hover:bg-[var(--color-primary)]/10 transition-colors text-xs"
...
<div class="sidebar-footer mt-auto border-t border-slate-200 dark:border-slate-800 pt-4 pb-2 overflow-hidden"
    ...
    <div class="flex items-center gap-x-3" :class="sidebarCollapsed ? 'justify-center px-0' : 'px-2'">
        ...
        <div x-show="!sidebarCollapsed" x-cloak class="flex-1 min-w-0 overflow-hidden">
            ...
            <div class="text-xs text-slate-500 dark:text-slate-300 mt-0.5 flex items-center gap-1.5 line-clamp-1">
                ...
                @if(Auth::user()?->getRoleNames()->isNotEmpty())
                    <span
                        class="px-1.5 py-0.5 rounded-full bg-slate-100 dark:bg-slate-700 text-slate-600 dark:text-slate-200 font-bold tracking-wide uppercase text-[0.68rem] shrink-0 border border-slate-200 dark:border-slate-600">
...
{{-- ── Copyright Footer ─────────────────────────────────────────── --}}
<div x-show="!sidebarCollapsed" x-cloak class="shrink-0 border-t border-slate-200 dark:border-slate-800 px-5 pt-3 pb-4">
...
<style>
    ...
    .dark-mode .toggle-subfolders-btn {
        color: #64748b;
    }
