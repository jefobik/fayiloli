<div class="document-properties">
    <div class="card">
        <div class="card-header">
            ...
            <img src="{{ global_asset('img/folder.png') }}" alt="" class="defaultImage" style="cursor: zoom-in"
        ...
        <div class="card-body addOverlay1 fileProperty" style="display: none">
            <div class="d-flex justify-content-between">
                <div class="btn-group share-buttons">
                    ...
                    <i class="fas fa-retweet" id="change" title="Replace" onclick="changeFileIcon(this, 'file')"></i>
