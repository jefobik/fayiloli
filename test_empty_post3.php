...
// Test Payload 2: Valid credentials except we omit the _token to trigger the 419 Page Expired
$postDataEmpty = http_build_query([
...
curl_setopt($ch, CURLOPT_POSTFIELDS, $postDataEmpty);
...
echo "Result Headers when CSRF is omitted:\n$header2\n";
