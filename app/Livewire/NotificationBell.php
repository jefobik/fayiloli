 ...
 * Polls every 15 seconds via wire:poll inside the Blade view.
 * Uses #[Locked] on all server-computed properties.
 */
class NotificationBell extends Component
{
    #[Locked] public int $count = 0;
    #[Locked] public array $notifications = [];
